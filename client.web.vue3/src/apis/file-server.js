 ...
 * @LastEditors: snltty
 * @LastEditTime: 2021-09-06 16:00:09
 * @version: v1.0.0
 * @Descripttion: 功能说明
...
export const getSpecialFolder = () => {
    return sendWebsocketMsg(`fileserver/SpecialFolder`);
}

export const getLocalFiles = (path = '', toid = 0) => {
    return sendWebsocketMsg(`fileserver/locallist`, { ToId: toid, Path: path });
}
