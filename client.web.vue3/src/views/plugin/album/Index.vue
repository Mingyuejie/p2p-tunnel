 ...
 * @LastEditors: snltty
 * @LastEditTime: 2021-09-24 17:20:45
 * @version: v1.0.0
 * @Descripttion: 功能说明
...
<template>
    <div class="flex flex-column flex-nowrap h-100">
        <div class="head t-c">
            ...
            <el-button size="mini" @click="handleVerify" :loading="loading">管理验证</el-button>
        </div>
        <div class="body flex-1 scrollbar">
            <Categorys v-if="cid == 0"></Categorys>
            <Album v-else>
                <el-button size="mini" type="info" @click="cid = 0">返回相册列表</el-button>
            </Album>
        </div>
    </div>
</template>
