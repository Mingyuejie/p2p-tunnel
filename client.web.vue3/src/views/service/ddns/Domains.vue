 ...
 * @LastEditors: xr
 * @LastEditTime: 2022-01-23 14:14:34
 * @version: v1.0.0
 * @Descripttion: 功能说明
 * @FilePath: \client.web.vue3\src\views\service\ddns\Domains.vue
-->
<template>
    <div>
...
<script>
import { getPlatforms, getDoamins, deleteDomain, addDoamin } from '../../../apis/service/ddns'
