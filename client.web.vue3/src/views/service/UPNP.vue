 ...
 * @LastEditors: xr
 * @LastEditTime: 2022-01-23 14:14:01
 * @version: v1.0.0
 * @Descripttion: 功能说明
 * @FilePath: \client.web.vue3\src\views\service\UPNP.vue
-->
<template>
    <div class="upnp-wrap">
        <div class="head">
...
import { getUpnpDevices, getUpnpMappings, sendUpnpDelMapping, sendUpnpAddMapping } from '../../apis/service/upnp'
