 ...
 * @LastEditors: xr
 * @LastEditTime: 2022-01-23 14:14:09
 * @version: v1.0.0
 * @Descripttion: 功能说明
 * @FilePath: \client.web.vue3\src\views\service\configure\Configure.vue
-->
<template>
...
import { getConfigures, enableConfigure } from '../../../apis/service/configure'
