 ...
 * @LastEditors: xr
 * @LastEditTime: 2022-01-23 14:36:04
 * @version: v1.0.0
 * @Descripttion: 功能说明
 * @FilePath: \client.web.vue3\src\views\service\configure\ConfigureModal.vue
-->
<template>
...
import { getConfigure, saveConfigure } from '../../../apis/service/configure'
